            ...
            <div className='mt-10'>
                ...
                <div className='text-primary/75 text-base mb-4'>
                    <div className='bg-blue text-white rounded-lg px-4 py-2 shadow-md'>
                        ...
                        <p>"Thanks to the jobPortal  on this platform, I found my dream job as a software developer at Linear Company. I couldn't be happier with the opportunities it has provided me."</p>
                    </div>
                    ...
                    <div className='bg-blue text-white rounded-lg px-4 py-2 shadow-md'>
                        <p className='mb-1'><strong>James Root - Data Science</strong></p>
                        <p>"Thank you JobPortal, for helping me secure a placement in Data Science! Your platform made the job search process easy and effective. I'm excited to start my new journey and grateful for your support!."</p>
                    </div>
