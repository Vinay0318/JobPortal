    ...
    return (
        ...
        <div className='max-w-screen-2x1 container mx-auto xl:px-24 px-4 '>
            ...
            <div className='max-w-screen-2xl container flex align-content justify-between mx-auto xl:px-4 px-4 md:py-20 py-14'>
                <div className='mt-8'>
                    <h1 className='text-5xl font-bold text-primary mb-3'>Find your <span className='text-blue'>Dream job</span></h1>
                    <p className='text-lg max-w-screen-sm text-black/70 mb-8'>Millions of jobs in the computer, engineering and technology  are waiting for you.</p>
                    <button className='mt-8 py-2 px-8 border rounded bg-blue text-white text-2xl'>Find</button>
                </div>
                <img src="/images/searches.jpg" alt="" className='max-w-md' />
            </div>
        </div>
    )
}
